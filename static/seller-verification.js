...
let rowOfPhotos = document.getElementById("seller-verification-row-photos-id");
...
const verificationRequest = new Object();
...
function submitVerificationForm () {
  let sellerVerificationName = document.getElementById("seller-verification-name-id").value;
  let sellerVerificationSurname = document.getElementById("seller-verification-surname-id").value;
  let sellerVerificationMonth = document.getElementById("seller-verification-month-id").value;
  let sellerVerificationDay = document.getElementById("seller-verification-day-id").value;
  let sellerVerificationYear = document.getElementById("seller-verification-year-id").value;
  let sellerVerificationCountry = document.getElementById("seller-verification-country-id").value;
  let sellerVerificationCity = document.getElementById("seller-verification-city-id").value;
  let sellerVerificationAddress = document.getElementById("seller-verification-address-id").value;
  let sellerVerificationPostalCode = document.getElementById("seller-verification-postal-code-id").value;

  if ((sellerVerificationDay >= 1 || sellerVerificationDay <= 31) && 
    ...
    firebase.firestore().doc(`verifications/${username}`).set(verification);
  } 
}
